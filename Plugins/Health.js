...
function Awake () {
	...
	{
		maxHealth = globals.playerMaxHealth;
		if(maxHealth == 0)
		{
			maxHealth = 100;
		...
		regenerateSpeed = globals.playerHealthRegenerationSpeed;
		if(regenerateSpeed == 0)
		{
			regenerateSpeed = 0.1;
			globals.playerHealthRegenerationSpeed = 0.1;
	...
	{
		maxHealth = globals.rangedEnemyMaxHealth;
		if(maxHealth == 0)
		{
			maxHealth = 20;
...
function OnDamage (amount : float, fromDirection : Vector3) {
	...
	*/
	...
	/******/
	//DON'T PUT ANY YIELD WAITFORSECONDS STATEMENTS HERE!!!!!!
	/******/
